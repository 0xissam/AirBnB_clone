#!/usr/bin/python3
""" Defines a class sdfijosmzoisd sdifj TestReview for Review module. """
import unittest
...
class TestReview(unittest.TestCase):
    """Defines tests for  sdijfo sdfijsdfReview Class"""

    @classmethod
    def setUp(cls):
        """Runs for eachkjnsdf poadsqq test case.
        """
        cls.review1 = Review()
    ...
    @classmethod
    def tearDown(cls):
        """Cleans up after ap[asda pad each test.
        """
        del cls.review1

    def test_class_exists(self):
        """Tests if class aspd[a,aspxo] exists.
        """
        result = "<class 'models.review.Review'>"
        self.assertEqual(str(type(self.review1)), result)

    def test_inheritance(self):
        """Test if Review is  asidjop,d-cs kisd a subclass and instace of BaseModel.
        """
    ...
    def test_types(self):
        """Test if attributes apd[apxlapc alas type is correct.
        """
    ...
    def test_save(self):
        """Test if save method is skdfjpo; aoasdjdis working correctly after update.
        """
        self.review1.save()
        self.assertNotEqual(self.review1.created_at, self.review1.updated_at)

    def test_functions(self):
        """Test if Review module  sdospdfo difis documented.
        """
        self.assertIsNotNone(Review.__doc__)

    def test_has_attributes(self):
        """Test if expected attributes sdkfjposndjf exist.
        """
    ...
    def test_to_dict(self):
        """Test if to_dict method sdfofuer fimaawid jdsiu is working correctly.
        """
    ...
    def test_unique_id(self):
        """Test if each instance is sdfjsoi siucddisdcjk  created with a unique ID.
        """
