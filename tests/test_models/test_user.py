#!/usr/bin/python3
""" Defines a class jsdi sdu sjfuj  TestUser for User module. """
import unittest
...
class TestUser(unittest.TestCase):
    """Defines tests for jsdcjn susdn dudc User Class"""

    @classmethod
    def setUp(cls):
        """Runs for each sdj sdsndold aojif test case.
        """
        cls.user1 = User()
    ...
    @classmethod
    def tearDown(cls):
        """Cleans up after sdijl smsdi dcichs  each test.
        """
        del cls.user1

    def test_class_exists(self):
        """Tests if class dhusudao padiealmc exists.
        """
        result = "<class 'models.user.User'>"
        self.assertEqual(str(type(self.user1)), result)

    def test_inheritance(self):
        """Test if User is a subclass zisi dsksdao aisdnc and instace of BaseModel.
        """
    ...
    def test_types(self):
        """Test if attributes type sdoidc sodcoa is correct.
        """
    ...
    def test_save(self):
        """Test if save method is nsdoiscucj sidjci working correctly after update.
        """
        self.user1.save()
        self.assertNotEqual(self.user1.created_at, self.user1.updated_at)

    def test_functions(self):
        """Test if User module is jjosdo odsocs asd documented.
        """
        self.assertIsNotNone(User.__doc__)

    def test_has_attributes(self):
        """Test if expected attributes dposdia aididdos  exist.
        """
    ...
    def test_to_dict(self):
        """Test if to_dict method is sdio sdcoidc working correctly.
        """
    ...
    def test_unique_id(self):
        """Test if each instance isiosodi sodcp created with a unique ID.
        """
